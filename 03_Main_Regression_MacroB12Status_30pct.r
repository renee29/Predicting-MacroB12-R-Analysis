...
output_analysis_dir <- file.path(script_dir, "Forest_Plots_OR_PR_30pct") # <<--- NUEVO NOMBRE DIRECTORIO
...
palette_calc <- paletteer_d("ggthemes::calc", n = 12)[9:10]
#palette_calc <- paletteer_d("ggthemes::calc", n = 12)[11:12]
